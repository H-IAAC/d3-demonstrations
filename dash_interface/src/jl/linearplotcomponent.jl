...
export linearplotcomponent

"""
    linearplotcomponent(;kwargs...)
    linearplotcomponent(children::Any;kwargs...)
    linearplotcomponent(children_maker::Function;kwargs...)


A LinearplotComponent component.
...
linearplotcomponent(children::Any; kwargs...) = linearplotcomponent(;kwargs..., children = children)
linearplotcomponent(children_maker::Function; kwargs...) = linearplotcomponent(children_maker(); kwargs...)
