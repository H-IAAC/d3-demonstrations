...
# -*- coding: utf-8 -*-
#
# ipywidgets_ts documentation build configuration file
#
...
project = 'ipywidgets_ts'
copyright = '2023, Daniel Adam Miranda'
...
_version_py = os.path.join(repo, 'ipywidgets_ts', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipywidgets_tsdoc'
...
latex_documents = [
    (master_doc, 'ipywidgets_ts.tex', 'ipywidgets_ts Documentation',
     'Daniel Adam Miranda', 'manual'),
]
